...
## Overview
The application initializes an SPI interface to communicate with a peer device as a SPI master. The standard 4 SPI wires and a flow control GPIO (FCO) are used for communicating
with the slave.  Following is the description of the protocol.
